...
Config.DeadsecStations = { -- Remplace 'DeadsecStations' par la fonction qui ouvre le menu des actions du gang
  Deadsec = { -- Remplace 'Deadsec' par le nom du groupe criminel
    Vehicles = {
      {
