...
Config.FamiliesStations = { -- Remplace 'FamiliesStations' par la fonction qui ouvre le menu des actions du gang
  Families = { -- Remplace 'Gang' par le nom du groupe criminel
    Vehicles = {
      {
