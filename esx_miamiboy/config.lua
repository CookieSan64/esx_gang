...
Config.MiamiboyStations = { -- Remplace 'MiamiboyStations' par la fonction qui ouvre le menu des actions du gang
  Miamiboy = { -- Remplace 'Gang' par le nom du groupe criminel
    Vehicles = {
      {
